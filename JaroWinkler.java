...
/*We calculate the JARO WINKLER distance between words in order to find similarity
 */
...
public class JaroWinkler {
	...
	{
		if(i<compOne.length() && i<compTwo.length() && (i-counter)<compTwo.length())
	...
	for (int i = 0; i < 4; i++)
	{
	if(i<compOne.length() && i<compTwo.length())
